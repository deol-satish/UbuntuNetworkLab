...
scp root@"$server_ipaddr":/home/ubuntu/iperf3_server_${tcp1}_${testname}.json "$save_dir"/
scp root@"$server_ipaddr":/home/ubuntu/iperf3_server_${tcp2}_${testname}.json "$save_dir"/
scp root@"$server_ipaddr":/home/ubuntu/pcap_server_${testname}.pcap "$save_dir"/

# Copy client-side JSON files to the directory in WSL
scp root@"$client1_ipaddr":/home/ubuntu/iperf3_client_${tcp1}_${testname}.json "$save_dir"/
scp root@"$client2_ipaddr":/home/ubuntu/iperf3_client_${tcp2}_${testname}.json "$save_dir"/
